#!/bin/bash
echo "🚀 완전히 깨끗한 ROS2 환경 설정 (최종 해결책 v2)"
echo "================================================"
...
# xacro 실행 파일을 커스텀 스크립트로 대체
echo "🔧 xacro 실행 파일을 커스텀 스크립트로 대체 중..."
alias xacro='python3 ~/gap_detect_v1_ws/scripts/xacro_ros2.py'
...
echo "🔧 xacro 테스트:"
echo "xacro 버전 확인:"
python3 ~/gap_detect_v1_ws/scripts/xacro_ros2.py --version
